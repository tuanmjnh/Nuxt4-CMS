  ...
  <div class="p-4">
    <div class="flex justify-between items-center mb-4">
      ...
      <div class="flex gap-2">
        <UButton to="/admin/products/inventory/import" color="success" icon="i-heroicons-arrow-down-tray">
          {{ $t('inventory.import') }}
        </UButton>
        <UButton to="/admin/products/inventory/export" color="error" icon="i-heroicons-arrow-up-tray">
          {{ $t('inventory.export') }}
        </UButton>
        <UButton to="/admin/products/inventory/transfer" color="primary" icon="i-heroicons-arrows-right-left">
